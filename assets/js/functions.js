...
!(function (e) {
    ...
    (SEMICOLON.initialize = {
        ...
        (SEMICOLON.header = {
            ...
            menufunctions: function () {
                let i,
                    ...
                    a = e(s),
                    l = I.attr("data-trigger-speed") || 200;
                (l = Number(l)),
                    ...
                    o.hasClass("device-xl") || o.hasClass("device-lg")
                        ...
                        : c.css({ "margin-top": "" }),
                    o.hasClass("overlay-menu") && I.hasClass("on-click") && (o.hasClass("device-xl") || o.hasClass("device-lg"))
                        ...
                        : (o.hasClass("side-header") && I.hasClass("on-click")) || o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")
                        ? (i.removeClass("icon-rotate-90"),
                          ...
                          (i = i.add(t.filter('[href^="#"]'))).off("click").on("click", function (i) {
                              ...
                              n.parents(".sub-menu").siblings().find(".sub-menu-trigger").removeClass("icon-rotate-90"),
                                  n.parents(".sub-menu").siblings().find(a).filter(":not(:animated)").stop(!0, !0).slideUp(l),
                                  n.parent(".menu-item").children(s).filter(":not(:animated)").stop(!0, !0).slideToggle(l);
                        ...
                        .on("click", function () {
                            return (
                                (o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")) &&
                                    (I.find(".mobile-primary-menu").length > 0
                                        ? (e(".primary-menu:not(.mobile-menu-off-canvas) .mobile-primary-menu").stop(!0, !0).slideToggle(l), e(".primary-menu.mobile-menu-off-canvas .mobile-primary-menu").toggleClass("d-block"))
                                        : (e(".primary-menu:not(.mobile-menu-off-canvas) .menu-container").stop(!0, !0).slideToggle(l), e(".primary-menu.mobile-menu-off-canvas .menu-container").toggleClass("d-block"))),
                                o.toggleClass("primary-menu-open"),
                                !1
                            );
                        }),
                    e(".menu-container:not(.mobile-primary-menu)").css({ display: "" }),
                    (o.hasClass("device-xl") || o.hasClass("device-lg")) && I.find(".mobile-primary-menu").removeClass("d-block");
            },
            ...
            menuItemsSpacing: function (e) {
                ...
                o.hasClass("side-header") ||
                    ...
                    (I.hasClass("menu-spacing-margin")
                        ? "" == e
            ...
            stickyPageMenu: function (e) {
                ...
                else $.removeClass("sticky-page-menu"), $.find(q).css({ top: "" });
            },
                ...
                e("#top-search-trigger")
                    ...
                    .on("click", function (e) {
                        clearTimeout(n),
                            ...
                            Y.toggleClass("top-cart-open", !1),
                            (o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")) &&
                                (I.filter(":not(.mobile-menu-off-canvas)").find(".menu-container").slideUp(200), I.filter(".mobile-menu-off-canvas").find(".menu-container").toggleClass("d-block", !1)),
                            ...
                            o.hasClass("top-search-open") && G.find("input").focus(),
                            e.stopPropagation(),
                            e.preventDefault();
                    });
            },
            topcart: function () {
                ...
                e("#top-cart-trigger")
                    .off("click")
                    .on("click", function (e) {
                        $.toggleClass("page-menu-open", !1), Y.toggleClass("top-cart-open"), e.stopPropagation(), e.preventDefault();
                    });
            },
            miscFunctions: function () {
                ...
                e(document).on("click", function (t) {
                    e(t.target).closest(".top-search-form").length ||
                        ...
                        e(t.target).closest("#top-cart").length || Y.toggleClass("top-cart-open", !1),
                        ...
                        e(t.target).closest(".primary-menu.on-click").length || I.filter(".on-click").find(".menu-container").find(".d-block").removeClass("d-block"),
                        e(t.target).closest(".primary-menu.mobile-menu-off-canvas .menu-container").length || I.filter(".mobile-menu-off-canvas").find(".menu-container").toggleClass("d-block", !1),
        ...
        (SEMICOLON.slider = {
            ...
            sliderDimensions: function () {
                let e = W.outerHeight(),
                    i = W.outerWidth(),
                    n = W.find(".slider-inner"),
                    t = V.find(".swiper-wrapper"),
                    s = V.find(".swiper-slide").first(),
                    a = V.hasClass("h-auto") || V.hasClass("min-vh-0");
                if (o.hasClass("device-xl") || o.hasClass("device-lg")) {
                    if (
                        (setTimeout(function () {
                            n.height(e), a && ((e = W.find(".slider-inner").children().first().outerHeight()), W.height(e), n.height(e));
                        }, 500),
                        a)
                    ) {
                ...
                } else t.css({ height: "" }), W.css({ height: "" }), n.css({ width: "", height: "" });
            },
            ...
            sliderParallaxOffset: function () {
                let e = 0,
                    i = d.outerHeight();
                return (o.hasClass("side-header") || d.next(".include-header").length > 0) && (i = 0), (e = J.length > 0 ? J.outerHeight() + i : i), V.next("#header").length > 0 && (e = 0), e;
            },
            ...
            sliderElementsFade: function () {
                ...
                if ((!o.hasClass("device-xl") && !o.hasClass("device-lg")) || SEMICOLON.isMobile.any()) W.find(".slider-arrow-left,.slider-arrow-right,.slider-caption,.slider-element-fade").css({ opacity: 1 });
                    ...
                    (e = d.hasClass("transparent-header") || o.hasClass("side-header") ? 100 : 0),
                        W.filter(".slider-parallax-visible")
    ...
    let i,
        ...
        v = d.attr("data-sticky-shrink") || "true",
        S = d.attr("data-sticky-shrink-offset") || 300,
        I = e(".primary-menu"),
        b = I.find(".menu-container:not(mobile-primary-menu):not(.custom-spacing)").children(".menu-item").children(".menu-link"),
        y = "",
        M = (u.outerHeight(), u.find(".header-row:eq(0)"), e("#content"), e("#footer")),
        L = l.width(),
        N = d.attr("class"),
        E = u.attr("class"),
    ...
    (function (e, i, n, t, s, a, l) {
        (e.GoogleAnalyticsObject = "ga"),
            ...
            (l = i.getElementsByTagName("script")[0]),
            (a.async = 1),
    ...
    jQuery(document).one("ajaxComplete", function () {
        jQuery(".preloader-demo").on("click", function (e) {
            var i = jQuery(this),
                n = jQuery(".preloader-demo"),
                t = i.attr("data-loader");
            n.prop("disabled", !0),
                "1" == t
                    ...
                    : "14" == t && (css3Loader = '<div class="css3-spinner-scale-ripple"><div></div><div></div><div></div></div>'),
                jQuery("body").append('<div class="page-transition-wrap"><div class="css3-spinner"></div></div>'),
                jQuery(".css3-spinner").html(css3Loader),
                setTimeout(function () {
                    jQuery(".page-transition-wrap").fadeOut("400", function () {
                        jQuery(this).remove(), n.prop("disabled", !1);
                    });
                }, 2e3),
                e.preventDefault();
        });
